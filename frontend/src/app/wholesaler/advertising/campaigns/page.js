  ...
  return (
    <PageShell>
      <PageHeader
        ...
        actions={
          <Link href="/wholesaler/advertising/create" className="px-5 py-2.5 bg-slate-900 text-white text-sm font-bold rounded-xl hover:bg-slate-800 shadow-md hover:shadow-lg transition-all flex items-center gap-2">
